// USE WHEN: storing/reading the in-progress booking (1h cookie) or confirmed booking (sessionStorage) — browser only.
...
// // Persist the booking selection for 1 hour.
// export const storeBookingDetails = (details) =>
//   Cookies.set(BOOKING_COOKIE_NAME, JSON.stringify(details), COOKIE_OPTIONS);

// // Read the booking selection back (null if absent/expired/unparseable).
